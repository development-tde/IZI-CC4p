...
#define CONF_CAN0_RXF0C_F0S 64		// Tried 64, it worked. But check message with CONF_CAN0_TXBC_TFQS, to be sure set it to 32 (rx fifo is 1152 bytes)
#endif
...
#define CONF_CAN0_TXBC_TFQS 32		// If set to 32 it fails. I think because the TX buffers have 0 - 576 words (pg 1302 in datasheet), 16 * (64 + 8) = 1152 / 2 = 576 words
#endif
...
#define CONF_CAN0_XIDAM_EIDM 0x1f003f00
#endif
