...
#ifndef CONF_TCC4_SEL_CH
#define CONF_TCC4_SEL_CH 0x1
#endif
...
#define CONF_TCC4_PER_REG                                                                                              \
((uint32_t)(((double)CONF_TCC4_WAVE_PER_VAL * CONF_GCLK_TCC4_FREQUENCY) / 1000000 / (1 << CONF_TCC4_PRESCALER) - 1))
#define CONF_TCC4_CCX_REG ((uint32_t)(((double)(double)CONF_TCC4_PER_REG * CONF_TCC4_WAVE_DUTY_VAL) / 1000))

#elif CONF_TCC4_PRESCALER == TCC_CTRLA_PRESCALER_DIV64_Val
#define CONF_TCC4_PER_REG ((uint32_t)(((double)CONF_TCC4_WAVE_PER_VAL * CONF_GCLK_TCC4_FREQUENCY) / 64000000 - 1))
#define CONF_TCC4_CCX_REG ((uint32_t)(((double)CONF_TCC4_PER_REG * CONF_TCC4_WAVE_DUTY_VAL) / 1000))

#elif CONF_TCC4_PRESCALER == TCC_CTRLA_PRESCALER_DIV256_Val
#define CONF_TCC4_PER_REG ((uint32_t)(((double)CONF_TCC4_WAVE_PER_VAL * CONF_GCLK_TCC4_FREQUENCY) / 256000000 - 1))
#define CONF_TCC4_CCX_REG ((uint32_t)(((double)CONF_TCC4_PER_REG * CONF_TCC4_WAVE_DUTY_VAL) / 1000))

#elif CONF_TCC4_PRESCALER == TCC_CTRLA_PRESCALER_DIV1024_Val
#define CONF_TCC4_PER_REG ((uint32_t)(((double)CONF_TCC4_WAVE_PER_VAL * CONF_GCLK_TCC4_FREQUENCY) / 1024000000 - 1))
#define CONF_TCC4_CCX_REG ((uint32_t)(((double)CONF_TCC4_PER_REG * CONF_TCC4_WAVE_DUTY_VAL) / 1000))
#endif
...
#ifndef CONF_TCC4_PWM_ENABLE
#define CONF_TCC4_PWM_ENABLE 1
#endif
...
// <TCC_CTRLA_PRESCALER_DIV256_Val"> Divide by 256
// <TCC_CTRLA_PRESCALER_DIV1024_Val"> Divide by 1024
// <i> This defines the TCC4 prescaler value
// <id> tcc_prescaler
...
// <hidden>
//<o> TCC4 Period Value <0x000000-0xFFFFFF>
// <id> tcc_per
#ifndef CONF_TCC4_PER
#define CONF_TCC4_PER 0x2710
#endif
// </hidden>
...
// <h> PWM Waveform Output settings
// <o> TCC4 Waveform Period Value (uS) <0x00-0xFFFFFFFF>
// <i> The unit of this value is us.
// <id> tcc_arch_wave_per_val
#ifndef CONF_TCC4_WAVE_PER_VAL
#define CONF_TCC4_WAVE_PER_VAL 0x3e8
#endif

// <o> TCC4 Waveform Duty Value (0.1%) <0x00-0x03E8>
// <i> The unit of this value is 1/1000.
// <id> tcc_arch_wave_duty_val
#ifndef CONF_TCC4_WAVE_DUTY_VAL
#define CONF_TCC4_WAVE_DUTY_VAL 0x1f4
#endif

// <o> TCC4 Waveform Channel Select <0x00-0x01>
// <i> Index of the Compare Channel register, into which the Waveform Duty Value is written.
...
/* Commented intentionally. Timer uses fixed value of the following bit(s)/bitfield(s) of CTRL A register.
 * May be used by other abstractions based on TC. */
//#define CONF_TCC4_RESOLUTION TCC_CTRLA_RESOLUTION_NONE_Val
// <q> Run in standby
// <i> Indicates whether the TCC4 will continue running in standby sleep mode or not
// <id> tcc_arch_runstdby
#ifndef CONF_TCC4_RUNSTDBY
#define CONF_TCC4_RUNSTDBY 0
#endif

// <y> TCC4 Prescaler and Counter Synchronization Selection
// <TCC_CTRLA_PRESCSYNC_GCLK_Val"> Reload or reset counter on next GCLK
// <TCC_CTRLA_PRESCSYNC_PRESC_Val"> Reload or reset counter on next prescaler clock
// <TCC_CTRLA_PRESCSYNC_RESYNC_Val"> Reload or reset counter on next GCLK and reset prescaler counter
// <i> These bits select if on retrigger event, the Counter should be cleared or reloaded on the next GCLK_TCCx clock or on the next prescaled GCLK_TCCx clock.
...
// <y> TCC4 Waveform Generation Selection
// <TCC_WAVE_WAVEGEN_NPWM_Val"> Single-slope PWM
// <TCC_WAVE_WAVEGEN_DSCRITICAL_Val"> Dual-slope, critical interrupt/event at ZERO (DSCRITICAL)
// <TCC_WAVE_WAVEGEN_DSBOTTOM_Val"> Dual-slope, interrupt/event at ZERO (DSBOTTOM)
// <TCC_WAVE_WAVEGEN_DSBOTH_Val"> Dual-slope, interrupt/event at Top and ZERO (DSBOTH)
...
#define CONF_TCC4_WAVEGEN TCC_WAVE_WAVEGEN_NPWM_Val
#endif
// <q> TCC4 Auto Lock
// <i> Indicates whether the TCC4 Auto Lock is enabled or not
// <id> tcc_arch_alock
#ifndef CONF_TCC4_ALOCK
#define CONF_TCC4_ALOCK 0
#endif

// <q> TCC4 Capture Channel 0 Enable
// <i> Indicates whether the TCC4 Capture Channel 0 is enabled or not
// <id> tcc_arch_cpten0
#ifndef CONF_TCC4_CPTEN0
#define CONF_TCC4_CPTEN0 0
#endif

// <q> TCC4 Capture Channel 1 Enable
// <i> Indicates whether the TCC4 Capture Channel 1 is enabled or not
// <id> tcc_arch_cpten1
...
// <hidden>
// <q> TCC4 Capture Channel 2 Enable
// <i> Indicates whether the TCC4 Capture Channel 2 is enabled or not
// <id> tcc_arch_cpten2
...
// </hidden>
// <hidden>
// <q> TCC4 Capture Channel 3 Enable
// <i> Indicates whether the TCC4 Capture Channel 3 is enabled or not
// <id> tcc_arch_cpten3
...
// </hidden>
// <hidden>
// <q> TCC4 Capture Channel 4 Enable
// <i> Indicates whether the TCC4 Capture Channel 4 is enabled or not
// <id> tcc_arch_cpten4
#ifndef CONF_TCC4_CPTEN4
#define CONF_TCC4_CPTEN4 0
#endif
// </hidden>
// <hidden>
// <q> TCC4 Capture Channel 5 Enable
// <i> Indicates whether the TCC4 Capture Channel 5 is enabled or not
// <id> tcc_arch_cpten5
#ifndef CONF_TCC4_CPTEN5
#define CONF_TCC4_CPTEN5 0
#endif
// </hidden>
// <hidden>
// <q> TCC4 Capture Channel 6 Enable
// <i> Indicates whether the TCC4 Capture Channel 6 is enabled or not
// <id> tcc_arch_cpten6
#ifndef CONF_TCC4_CPTEN6
#define CONF_TCC4_CPTEN6 0
#endif
// </hidden>
// <hidden>
// <q> TCC4 Capture Channel 7 Enable
// <i> Indicates whether the TCC4 Capture Channel 7 is enabled or not
// <id> tcc_arch_cpten7
#ifndef CONF_TCC4_CPTEN7
#define CONF_TCC4_CPTEN7 0
#endif
// </hidden>

// <q> TCC4 Lock update
// <i> Indicates whether the TCC4 Lock update is enabled or not
// <id> tcc_arch_lupd
#ifndef CONF_TCC4_LUPD
#define CONF_TCC4_LUPD 1
#endif

/* Commented intentionally. Timer uses fixed value of the following bit(s)/bitfield(s) of CTRL B register.
 * May be used by other abstractions based on TC. */
//#define CONF_TCC4_DIR     0
//#define CONF_TCC4_ONESHOT 0

/* Commented intentionally. No fault control for timers. */
/*#define CONF_TCC4_FAULT_A_SRC       TCC_FCTRLA_SRC_DISABLE_Val
#define CONF_TCC4_FAULT_A_KEEP        0
#define CONF_TCC4_FAULT_A_QUAL        0
#define CONF_TCC4_FAULT_A_BLANK       TCC_FCTRLA_BLANK_DISABLE_Val
#define CONF_TCC4_FAULT_A_RESTART     0
#define CONF_TCC4_FAULT_A_HALT        TCC_FCTRLA_HALT_DISABLE_Val
#define CONF_TCC4_FAULT_A_CHSEL       TCC_FCTRLA_CHSEL_CC0_Val
#define CONF_TCC4_FAULT_A_CAPTURE     TCC_FCTRLA_CAPTURE_DISABLE_Val
#define CONF_TCC4_FAULT_A_BLACNKPRESC 0
#define CONF_TCC4_FAULT_A_BLANKVAL    0
#define CONF_TCC4_FAULT_A_FILTERVAL   0

#define CONF_TCC4_FAULT_B_SRC         TCC_FCTRLB_SRC_DISABLE_Val
#define CONF_TCC4_FAULT_B_KEEP        0
#define CONF_TCC4_FAULT_B_QUAL        0
#define CONF_TCC4_FAULT_B_BLANK       TCC_FCTRLB_BLANK_DISABLE_Val
#define CONF_TCC4_FAULT_B_RESTART     0
#define CONF_TCC4_FAULT_B_HALT        TCC_FCTRLB_HALT_DISABLE_Val
#define CONF_TCC4_FAULT_B_CHSEL       TCC_FCTRLB_CHSEL_CC0_Val
#define CONF_TCC4_FAULT_B_CAPTURE     TCC_FCTRLB_CAPTURE_DISABLE_Val
#define CONF_TCC4_FAULT_B_BLACNKPRESC 0
#define CONF_TCC4_FAULT_B_BLANKVAL    0
#define CONF_TCC4_FAULT_B_FILTERVAL   0*/

/* Commented intentionally. No dead-time control for timers. */
/*#define CONF_TCC4_OTMX   0
#define CONF_TCC4_DTIEN0 0
#define CONF_TCC4_DTIEN1 0
#define CONF_TCC4_DTIEN2 0
#define CONF_TCC4_DTIEN3 0
#define CONF_TCC4_DTHS   0*/

/* Commented intentionally. No driver control for timers. */
/*#define CONF_TCC4_NRE0       0
#define CONF_TCC4_NRE1       0
#define CONF_TCC4_NRE2       0
#define CONF_TCC4_NRE3       0
#define CONF_TCC4_NRE4       0
#define CONF_TCC4_NRE5       0
#define CONF_TCC4_NRE6       0
#define CONF_TCC4_NRE7       0
#define CONF_TCC4_NVR0       0
#define CONF_TCC4_NVR1       0
#define CONF_TCC4_NVR2       0
#define CONF_TCC4_NVR3       0
#define CONF_TCC4_NVR4       0
#define CONF_TCC4_NVR5       0
#define CONF_TCC4_NVR6       0
#define CONF_TCC4_NVR7       0
#define CONF_TCC4_INVEN0     0
#define CONF_TCC4_INVEN1     0
#define CONF_TCC4_INVEN2     0
#define CONF_TCC4_INVEN3     0
#define CONF_TCC4_INVEN4     0
#define CONF_TCC4_INVEN5     0
#define CONF_TCC4_INVEN6     0
#define CONF_TCC4_INVEN7     0
#define CONF_TCC4_FILTERVAL0 0
#define CONF_TCC4_FILTERVAL1 0*/

// <q> TCC4 Debug Running Mode
// <i> Indicates whether the TCC4 Debug Running Mode is enabled or not
// <id> tcc_arch_dbgrun
...
/* Commented intentionally. No pattern control for timers. */
/*#define CONF_TCC4_PGE0 0
#define CONF_TCC4_PGE1 0
#define CONF_TCC4_PGE2 0
#define CONF_TCC4_PGE3 0
#define CONF_TCC4_PGE4 0
#define CONF_TCC4_PGE5 0
#define CONF_TCC4_PGE6 0
#define CONF_TCC4_PGE7 0
#define CONF_TCC4_PGV0 0
#define CONF_TCC4_PGV1 0
#define CONF_TCC4_PGV2 0
#define CONF_TCC4_PGV3 0
#define CONF_TCC4_PGV4 0
#define CONF_TCC4_PGV5 0
#define CONF_TCC4_PGV6 0
#define CONF_TCC4_PGV7 0*/

/* Commented intentionally. No pattern waveform control for timers. */
/*#define CONF_TCC4_WAVEGEN TCC_WAVE_WAVEGEN_MFRQ_Val
#define CONF_TCC4_RAMP    TCC_WAVE_RAMP_RAMP1_Val
#define CONF_TCC4_CIPEREN 0
#define CONF_TCC4_CICCEN0 0
#define CONF_TCC4_CICCEN1 0
#define CONF_TCC4_CICCEN2 0
#define CONF_TCC4_CICCEN3 0
#define CONF_TCC4_POL0    0
#define CONF_TCC4_POL1    0
#define CONF_TCC4_POL2    0
#define CONF_TCC4_POL3    0
#define CONF_TCC4_POL4    0
#define CONF_TCC4_POL5    0
#define CONF_TCC4_POL6    0
#define CONF_TCC4_POL7    0
#define CONF_TCC4_SWAP0   0
#define CONF_TCC4_SWAP1   0
#define CONF_TCC4_SWAP2   0
#define CONF_TCC4_SWAP3   0*/

//<o> TCC4 Compare and Capture value 0 <0x00-0xFFFF>
// <id> tcc_arch_cc0
#ifndef CONF_TCC4_CC0
#define CONF_TCC4_CC0 0x0
#endif

//<o> TCC4 Compare and Capture value 1 <0x00-0xFFFF>
// <id> tcc_arch_cc1
#ifndef CONF_TCC4_CC1
#define CONF_TCC4_CC1 0x0
#endif

// <hidden>
//<o> TCC4 Compare and Capture value 2 <0x000000-0xFFFFFF>
// <id> tcc_arch_cc2
#ifndef CONF_TCC4_CC2
#define CONF_TCC4_CC2 0x0
#endif
// </hidden>
// <hidden>
//<o> TCC4 Compare and Capture value 3 <0x000000-0xFFFFFF>
// <id> tcc_arch_cc3
#ifndef CONF_TCC4_CC3
#define CONF_TCC4_CC3 0x0
#endif
// </hidden>

/* Commented intentionally. No pattern control for timers. */
/*#define CONF_TCC4_PATTB_PGEB0 0
#define CONF_TCC4_PATTB_PGEB1 0
#define CONF_TCC4_PATTB_PGEB2 0
#define CONF_TCC4_PATTB_PGEB3 0
#define CONF_TCC4_PATTB_PGEB4 0
#define CONF_TCC4_PATTB_PGEB5 0
#define CONF_TCC4_PATTB_PGEB6 0
#define CONF_TCC4_PATTB_PGEB7 0
#define CONF_TCC4_PATTB_PGVB0 0
#define CONF_TCC4_PATTB_PGVB1 0
#define CONF_TCC4_PATTB_PGVB2 0
#define CONF_TCC4_PATTB_PGVB3 0
#define CONF_TCC4_PATTB_PGVB4 0
#define CONF_TCC4_PATTB_PGVB5 0
#define CONF_TCC4_PATTB_PGVB6 0
#define CONF_TCC4_PATTB_PGVB7 0*/

/* Commented intentionally. No waveform control for timers. */
/*#define CONF_TCC4_WAVEGENB TCC_WAVEB_WAVEGENB_MFRQ_Val
#define CONF_TCC4_RAMPB    TCC_WAVE_RAMP_RAMP1_Val
#define CONF_TCC4_CIPERENB 0
#define CONF_TCC4_CICCEN0B 0
#define CONF_TCC4_CICCEN1B 0
#define CONF_TCC4_CICCEN2B 0
#define CONF_TCC4_CICCEN3B 0
#define CONF_TCC4_POL0B    0
#define CONF_TCC4_POL1B    0
#define CONF_TCC4_POL2B    0
#define CONF_TCC4_POL3B    0
#define CONF_TCC4_POL4B    0
#define CONF_TCC4_POL5B    0
#define CONF_TCC4_POL6B    0
#define CONF_TCC4_POL7B    0
#define CONF_TCC4_SWAP0B   0
#define CONF_TCC4_SWAP1B   0
#define CONF_TCC4_SWAP2B   0
#define CONF_TCC4_SWAP3B   0*/

/* Commented intentionally. No buffering for timers. */
/*#define CONF_TCC4_PERB 0
#define CONF_TCC4_CCB0 0
#define CONF_TCC4_CCB1 0
#define CONF_TCC4_CCB2 0
#define CONF_TCC4_CCB3 0*/
// </h>

#define CONF_TCC4_CTRLA                                                                                                \
	TCC_CTRLA_PRESCALER(CONF_TCC4_PRESCALER) | (CONF_TCC4_RUNSTDBY << TCC_CTRLA_RUNSTDBY_Pos)                          \
	    | TCC_CTRLA_PRESCSYNC(CONF_TCC4_PRESCSYNC) | (CONF_TCC4_CPTEN0 << TCC_CTRLA_CPTEN0_Pos)                        \
	    | (CONF_TCC4_CPTEN1 << TCC_CTRLA_CPTEN1_Pos) | (CONF_TCC4_ALOCK << TCC_CTRLA_ALOCK_Pos)
#define CONF_TCC4_CTRLB (CONF_TCC4_LUPD << TCC_CTRLBSET_LUPD_Pos)
#define CONF_TCC4_DBGCTRL (CONF_TCC4_DBGRUN << TCC_DBGCTRL_DBGRUN_Pos)
#define CONF_TCC4_EVCTRL                                                                                               \
	TCC_EVCTRL_CNTSEL(CONF_TCC4_CNTSEL) | (CONF_TCC4_OVFEO << TCC_EVCTRL_OVFEO_Pos)                                    \
	    | (CONF_TCC4_TRGEO << TCC_EVCTRL_TRGEO_Pos) | (CONF_TCC4_CNTEO << TCC_EVCTRL_CNTEO_Pos)                        \
	    | (CONF_TCC4_MCEO0 << TCC_EVCTRL_MCEO0_Pos) | (CONF_TCC4_MCEI0 << TCC_EVCTRL_MCEI0_Pos)                        \
	    | (CONF_TCC4_MCEO1 << TCC_EVCTRL_MCEO1_Pos) | (CONF_TCC4_MCEI1 << TCC_EVCTRL_MCEI1_Pos)                        \
	    | (CONF_TCC4_TCEI0 << TCC_EVCTRL_TCEI0_Pos) | (CONF_TCC4_TCEI1 << TCC_EVCTRL_TCEI1_Pos)                        \
	    | (CONF_TCC4_TCINV0 << TCC_EVCTRL_TCINV0_Pos) | (CONF_TCC4_TCINV1 << TCC_EVCTRL_TCINV1_Pos)                    \
	    | TCC_EVCTRL_EVACT1(CONF_TCC4_EVACT1) | TCC_EVCTRL_EVACT0(CONF_TCC4_EVACT0)
