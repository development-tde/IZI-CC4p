...
void NonMaskableInt_Handler2(void);
void HardFault_Handler2(void);
void MemManagement_Handler2(void);
void BusFault_Handler2(void);
void UsageFault_Handler2(void);

/* Cortex-M4 core handlers */
void NonMaskableInt_Handler  ( void ) __attribute__ ((weak, alias("NonMaskableInt_Handler2")));
void HardFault_Handler       ( void ) __attribute__ ((weak, alias("HardFault_Handler2")));
void MemManagement_Handler   ( void ) __attribute__ ((weak, alias("MemManagement_Handler2")));
void BusFault_Handler        ( void ) __attribute__ ((weak, alias("BusFault_Handler2")));
void UsageFault_Handler      ( void ) __attribute__ ((weak, alias("UsageFault_Handler2")));
void SVCall_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2")));
void DebugMonitor_Handler    ( void ) __attribute__ ((weak, alias("Dummy_Handler2")));
void PendSV_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2")));
void SysTick_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler2")));
...
void FREQM_Handler           ( void ) __attribute__ ((weak, alias("Dummy_Handler3")));
void NVMCTRL_0_Handler       ( void ) __attribute__ ((weak, alias("Dummy_Handler3"))); /* NVMCTRL_0, NVMCTRL_1, NVMCTRL_2, NVMCTRL_3, NVMCTRL_4, NVMCTRL_5, NVMCTRL_6, NVMCTRL_7 */
void NVMCTRL_1_Handler       ( void ) __attribute__ ((weak, alias("Dummy_Handler3"))); /* NVMCTRL_10, NVMCTRL_8, NVMCTRL_9 */
...
void EVSYS_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler3"))); /* EVSYS_EVD_0, EVSYS_OVR_0 */
void EVSYS_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler3"))); /* EVSYS_EVD_1, EVSYS_OVR_1 */
void EVSYS_2_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler3"))); /* EVSYS_EVD_2, EVSYS_OVR_2 */
void EVSYS_3_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler3"))); /* EVSYS_EVD_3, EVSYS_OVR_3 */
void EVSYS_4_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler3"))); /* EVSYS_EVD_10, EVSYS_EVD_11, EVSYS_EVD_4, EVSYS_EVD_5, EVSYS_EVD_6, EVSYS_EVD_7, EVSYS_EVD_8, EVSYS_EVD_9, EVSYS_OVR_10, EVSYS_OVR_11, EVSYS_OVR_4, EVSYS_OVR_5, EVSYS_OVR_6, EVSYS_OVR_7, EVSYS_OVR_8, EVSYS_OVR_9 */
void PAC_Handler             ( void ) __attribute__ ((weak, alias("Dummy_Handler3")));
void RAMECC_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler3")));
...
#endif
void TCC0_0_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC0_CNT_A, TCC0_DFS_A, TCC0_ERR_A, TCC0_FAULT0_A, TCC0_FAULT1_A, TCC0_FAULTA_A, TCC0_FAULTB_A, TCC0_OVF, TCC0_TRG, TCC0_UFS_A */
void TCC0_1_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC0_MC_0 */
void TCC0_2_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC0_MC_1 */
void TCC0_3_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC0_MC_2 */
void TCC0_4_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC0_MC_3 */
void TCC0_5_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC0_MC_4 */
void TCC0_6_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC0_MC_5 */
void TCC1_0_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC1_CNT_A, TCC1_DFS_A, TCC1_ERR_A, TCC1_FAULT0_A, TCC1_FAULT1_A, TCC1_FAULTA_A, TCC1_FAULTB_A, TCC1_OVF, TCC1_TRG, TCC1_UFS_A */
void TCC1_1_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC1_MC_0 */
void TCC1_2_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC1_MC_1 */
void TCC1_3_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC1_MC_2 */
void TCC1_4_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC1_MC_3 */
void TCC2_0_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC2_CNT_A, TCC2_DFS_A, TCC2_ERR_A, TCC2_FAULT0_A, TCC2_FAULT1_A, TCC2_FAULTA_A, TCC2_FAULTB_A, TCC2_OVF, TCC2_TRG, TCC2_UFS_A */
void TCC2_1_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC2_MC_0 */
void TCC2_2_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC2_MC_1 */
void TCC2_3_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler2"))); /* TCC2_MC_2 */
#ifdef ID_TCC3
